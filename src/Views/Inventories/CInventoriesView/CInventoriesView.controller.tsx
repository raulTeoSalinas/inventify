...
const useCInventoriesView = () => {
  ...
  // const route = useRoute({ screenName: "CInventoriesView" });
  ...
  //     showToast({
  //       type: "error",
  //       title: "CInventories_TOAST_CREATE_ERROR",
  ...
  //       type: "success",
  //       title: "GENERAL_SUCCESS_TOAST",
  //       message: "CInventories_TOAST_DELETE_MSG"
  //     })
  ...
  //     showToast({
  //       type: "error",
  //       title: "CInventories_TOAST_EDIT_ERROR",
  //       message: "CInventories_TOAST_DELETE_ERROR"
  //     })
  //   }
  // }
  ...
  //       type: "success",
  //       title: "GENERAL_SUCCESS_TOAST",
  //       message: "CInventories_TOAST_EDIT_MSG"
  //     })
  //     navigation.goBack()
  //     return;
  //   }
